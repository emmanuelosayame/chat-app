...
export const StickerIcon = (props: any) => (
  <Icon viewBox="0 0 324.908 324.908" {...props}>
    <path
      fill="currentColor"
      d="M324.36,122.292c-7.444-27.881-22.219-53.457-42.726-73.964C250.471,17.163,209.035,0,164.962,0
...
export const MicWaveIcon = (props: any) => (
  <Icon viewBox="0 0 47 47" {...props}>
    <path
      fill="currentColor"
      d="M2.41,31.936c-1.331,0-2.41-1.078-2.41-2.41v-12.05c0-1.331,1.079-2.41,2.41-2.41s2.41,1.079,2.41,2.41v12.05
				C4.82,30.855,3.741,31.936,2.41,31.936z M9.44,37.962c-1.331,0-2.41-1.079-2.41-2.41V11.448c0-1.331,1.079-2.41,2.41-2.41s2.41,1.079,2.41,2.41v24.104
				C11.851,36.883,10.771,37.962,9.44,37.962z M16.47,34.948c-1.331,0-2.41-1.079-2.41-2.41V14.462c0-1.331,1.079-2.41,2.41-2.41c1.331,0,2.411,1.079,2.411,2.41
				v18.076C18.88,33.869,17.801,34.948,16.47,34.948z M23.5,40.975c-1.331,0-2.41-1.078-2.41-2.41V8.436c0-1.331,1.079-2.41,2.41-2.41s2.41,1.079,2.41,2.41v30.128
				C25.91,39.896,24.831,40.975,23.5,40.975z M30.529,47c-1.33,0-2.41-1.079-2.41-2.41V2.41c0-1.331,1.08-2.41,2.41-2.41c1.332,0,2.41,1.079,2.41,2.41v42.18
				C32.939,45.921,31.861,47,30.529,47z M37.561,37.962c-1.332,0-2.41-1.079-2.41-2.41V11.448c0-1.331,1.078-2.41,2.41-2.41c1.33,0,2.41,1.079,2.41,2.41v24.104
				C39.971,36.883,38.891,37.962,37.561,37.962z M44.59,28.923c-1.331,0-2.41-1.079-2.41-2.409v-6.026c0-1.331,1.079-2.41,2.41-2.41S47,19.157,47,20.488v6.026
...
export const AttachmentIcon = (props: any) => (
  <Icon viewBox="0 0 487.998 487.998" {...props}>
    <path
      fill="currentColor"
      d="M443.872,62.432L341.67,1.437c-2.298-1.4-4.995-1.8-7.593-1.1s-4.795,2.4-6.094,4.7L122.78,360.908
...
export const GoogleIcon = (props: any) => (
  <Icon viewBox="-380.2 274.7 65.7 65.8" {...props}>
    <path
      fill="currentColor"
      d="M443.872,62.432L341.67,1.437c-2.298-1.4-4.995-1.8-7.593-1.1s-4.795,2.4-6.094,4.7L122.78,360.908
			c-2.697,4.7-1.099,10.799,3.597,13.599l51.451,30.498c2.398,1.4,5.095,1.8,7.693,1.1s4.795-2.4,6.094-4.7L365.248,96.53
...
export const GoogleLogoIcon = (props: IconProps) => (
  <Icon viewBox='-380.2 274.7 65.7 65.8' {...props}>
    ...
    <clipPath id='google_svg__b'>
      <use overflow='visible' xlinkHref='#google_svg__a' />
    </clipPath>
    <path
      fill='#fbbc05'
    ...
    <clipPath id='google_svg__d'>
      <use overflow='visible' xlinkHref='#google_svg__c' />
    </clipPath>
    <path
      fill='#ea4335'
      d='m-370.8 294.3 17 13 7-6.1 24-3.9v-14h-48z'
      clipPath='url(#google_svg__d)'
    />
    <defs>
      <path
        id='google_svg__e'
    ...
    <clipPath id='google_svg__f'>
      <use overflow='visible' xlinkHref='#google_svg__e' />
    </clipPath>
    <path
      fill='#34a853'
      d='m-370.8 320.3 30-23 7.9 1 10.1-15v48h-48z'
      clipPath='url(#google_svg__f)'
    />
    <defs>
      <path
        id='google_svg__g'
    ...
    <clipPath id='google_svg__h'>
      <use overflow='visible' xlinkHref='#google_svg__g' />
    </clipPath>
    <path
      fill='#4285f4'
      d='m-322.8 331.3-31-24-4-3 35-10z'
      clipPath='url(#google_svg__h)'
    />
  </Icon>
);